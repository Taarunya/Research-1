...
> | Author | GitHub |
> |--------|--------|
> | Taarunya Aggarwal | [@taarunya aggarwal](https://github.com/Taarunya) |
> | Pranay Mahajan | [@pranay mahajan](https://github.com/pranaysensei31) |
...
| Layer | Purpose |
|---|---|
| Convolutional layers | Hierarchical spatial feature extraction |
...
```bash
pip3 install tensorflow numpy matplotlib scikit-learn opencv-python
```
...
### 3. Run the pipeline
```bash
python3 src/preprocess.py      # Preprocessing + NDVI computation
